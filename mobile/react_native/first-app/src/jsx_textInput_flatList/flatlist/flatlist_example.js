...
export default function FlatListExemplo() {
  const alunos = [
    { id: "1", nome: "Heloísa", nota: 10 },
    { id: "2", nome: "Anna", nota: 9.5 },
    { id: "3", nome: "Benício", nota: 9.0 },
    { id: "4", nome: "Joaquim", nota: 8.5 },
    { id: "5", nome: "Maria", nota: 8.0 },
  ];
...
const styles = StyleSheet.create({
  ...
  exemploLista: {
    width: "80%",
    // height: 250, // pra diminuir o espaço da lista...
    padding: 16,
    marginBottom: 16,
    backgroundColor: "#fff",
    borderRadius: 8,
